...
<p>
  before we start, here's how virtualenvwrapper works: it separates our project
...
<p>
  with that, my text editor is able to suggest module/class/function names from
...
<p>
  ...
  <strong>start project dependencies/fire up docker containers, or whatever you
    want</strong>. you can even make a cow tell you your evnironment directory.
</p>
<figure>
  <a href={cowsay}>
