...
<p>
  ...
  clássico
  <code>npm install redux react-redux --save</code>. Eu até compartilhei algumas
...
<p>
  Não ache que eu odeio o redux; pelo contrário, eu amo. Ele cumpre sua função,
...
<p>
  ...
  estritamente o que precisa ser feito. Zero abstração. E muita cópia e cola.
</p>
<p>
...
<p>
  ...
  usar sagas, mas aí o redux volta pra nos atazanar em dobro.
</p>
<p>
...
<ul>
  ...
  <li>
    encadear um Event/HTTPEvent em outro (útil pra quando você quer buscar mais
    dados depois que um evento teve sucesso);
  </li>
  <li>
  ...
  <li>
    executar código depois das mudanças de estado de um Evento que foi disparado
    (usando
