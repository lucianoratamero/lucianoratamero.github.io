...
<svelte:head>
  <MetaTags
    ...
    description="agora que já expliquei o básico de como utilizar o Lektor pra desenvolver seu site estático, vou começar a explicar alguns aspectos mais avançados. :]"
    keywords="lektor, python, site estático, deploy, macros, admin, plugins" />
</svelte:head>

<h1><mark>Lektor parte 2: deploy, macros, admin e plugins</mark></h1>

<PostMeta date="2016-02-03" {text} />
...
<article bind:this={el}>
  ...
  <p>
    agora que já expliquei o básico de como utilizar o Lektor pra desenvolver
  ...
  <p>
    ...
    um site pronto, com deploy e tudo.
  </p>
  <p>
    o deploy dele é facilmente configurado e bem inteligente, já que ele
...
`)} />
  ...
  <a href={admin}>
    <figure><img src={admin} alt="Exemplo de página de admin" /></figure>
  </a>
  <p>
  ...
  <p>
    ...
    <a href="https://www.getlektor.com/docs/plugins/">página de plugins do
      Lektor</a>
...
`)} />
  ...
  <p>
    depois disso, fui no
    <a
      href="https://publishers.disqus.com/engage?utm_source=Home-Nav">disqus</a>
