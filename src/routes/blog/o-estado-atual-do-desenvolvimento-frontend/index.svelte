...
<p>
  o negócio é o seguinte, a mensagem é bem simples: fomos longe demais. demais.
  tipo, muito. paramos de pensar no que é desenvolver no cliente, para o
  cliente, e isso é tudo culpa do javascript.
</p>
...
<p>
  ...
  falta e acabo sempre voltando ao javascript.
</p>
<p>
  o fato é que
...
<p>
  faz um mês em que peguei dois projetos em react pra fazer, e vou dizer que não
  ...
  <strong>se você precisa de um mês pra fazer uma página básica, tem alguma
    coisa errada</strong>. por mais simples que pareça, a máquina de estados do
...
<p>
  ...
  <strong>só agora eu tô entendendo como fazer um ajax direito</strong>. não sei
...
<p>
  ...
  bem,
  <strong>o site todo é em js</strong>. isso significa que, na prática, temos 1
  ...
  que todos seus usuários baixem o troço todo de novo.
</p>
<p>
  ...
  <em>sem toda aquela doideira de compilar nada</em>. só tenho um minificador e
  tá valendo.
</p>
<p>
...
<p>
  ...
  usuário, ou seja,
  <strong>que o usuário não perceba o meio, e sim a mensagem</strong>. mas, ó, o
...
<p>
  é mesmo? sei lá, até hoje eu só tive problema com o fato de não entender como
  ...
  cumprir por algum problema de especificação.
</p>
<p>
  pra se ter um projeto de backend desacoplado do frontend de maneira saudável,
  é
...
<p>
  ...
  mais desacoplado do de back.
</p>
<p>
  <strong>o problema é incentivar que os fronts só saibam de front e os backs só
    saibam de back.</strong>
...
<p>
  ...
  código, já que os sintomas de um código ruim aparecem rapidinho.
</p>
<p>
  o mesmo não acontece com js, então os frameworks e bibliotecas tomaram pra si
  o papel de obrigar um certo nível de organização do código - e isso é ótimo.
  mas o que eles estão te obrigando a fazer, cara,
  <strong>não deveria ser mais do que sua obrigação</strong>. organizar o código
...
<p>
  sim, sim. o advento do virtual DOM foi um grande possibilitador de aplicações
