...
<p>
  ...
  -
  <strong>nem sempre pro bem</strong>. O pior é que todo dev frontend que eu já
  ...
  processamento de dados. O resultado: react-redux-api-tools.
</p>
<h2>Vamos imaginar um cenário comum: CRUD</h2>
<p>
  Já que o javascript é muito permissivo, há inúmeras maneiras de implementarmos
...
<p>
  ...
  <strong>renderizar os dados</strong>. Se, por exemplo, você precisasse limpar
...
`)} />
<p>
  Isso resolve grande parte dos problemas, mas eu diria que essa solução acopla
  ...
  todos os problemas, pelo menos os mais importantes, seria algo similar a isso:
</p>
<ul class="callout">
...
<p>
  ...
  <strong>fora do componente</strong>. Componentes devem renderizar coisas, não
...
<p>
  ...
  <strong>middlewares do redux são maravilhosos</strong>. Imaginem que queremos
  ...
  <strong>decidisse quais reducers disparar</strong>. Assim, deixaríamos o redux
...
<ul class="callout">
  ...
  <li>
    <strong>Middleware chama a função da requisição, guarda a promise e dispara
      reducer de isLoading</strong>
  </li>
  <li>Componente renderiza isLoading</li>
  <li>
...
<p>
  ...
  reducers se manteriam inalterados:
</p>
<Highlight
  language={javascript}
  code={formatCodeString(`
...
<p>
  ...
  seu código usando nossas ferramentas! Obrigado, e até a próxima!
</p>
