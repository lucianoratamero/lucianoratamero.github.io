...
<p>
  ...
  <strong>not always for the good</strong>. The worst part is that every single
...
<p>
  Since javascript is too permissive, there are endless ways to make a CRUD SPA.
...
<p>
  1.The request is being made inside a component, which, in theory, should have
  only one job:
...
<p>
  Redux is one of the most amazing tools for the job. So let’s say you’re using
